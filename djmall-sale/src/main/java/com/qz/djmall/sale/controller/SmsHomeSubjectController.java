...
import com.qz.djmall.sale.service.SmsHomeSubjectService;
 ...
 */
@RestController
@RequestMapping("sale/smshomesubject")
public class SmsHomeSubjectController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("sale:smshomesubject:list")
    ...
    //@RequiresPermissions("sale:smshomesubject:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("sale:smshomesubject:save")
    ...
    //@RequiresPermissions("sale:smshomesubject:update")
    ...
    //@RequiresPermissions("sale:smshomesubject:delete")
