...
import com.qz.djmall.sale.service.SmsSeckillPromotionService;
 ...
 */
@RestController
@RequestMapping("sale/smsseckillpromotion")
public class SmsSeckillPromotionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("sale:smsseckillpromotion:list")
    ...
    //@RequiresPermissions("sale:smsseckillpromotion:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("sale:smsseckillpromotion:save")
    ...
    //@RequiresPermissions("sale:smsseckillpromotion:update")
    ...
    //@RequiresPermissions("sale:smsseckillpromotion:delete")
