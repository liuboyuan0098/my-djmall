...
import com.qz.djmall.sale.service.SmsSkuFullReductionService;
 ...
 */
@RestController
@RequestMapping("sale/smsskufullreduction")
public class SmsSkuFullReductionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("sale:smsskufullreduction:list")
    ...
    //@RequiresPermissions("sale:smsskufullreduction:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("sale:smsskufullreduction:save")
    ...
    //@RequiresPermissions("sale:smsskufullreduction:update")
    ...
    //@RequiresPermissions("sale:smsskufullreduction:delete")
